...
**_(c) From the observational study, the probabilities graph clearly suggest O-ring will be damage at lower temperatures. Study suggests, O-ring is critical part that can cause space shuttle to explode at low temperatures. Shuttle launch decision should be erred on the side of caution if temperatures are lower than $56^\circ F$._**
